...
import kotlin.text.CustomCharsKt;
...
public final class RealBufferedSource implements BufferedSource {
    ...
    @Override // okio.BufferedSource
    public boolean rangeEquals(long j, ByteString bytes) throws IOException {
        Intrinsics.checkParameterIsNotNull(bytes, "bytes");
    ...
    @Override // okio.BufferedSource
    public long readAll(Sink sink) throws Throwable {
        Intrinsics.checkParameterIsNotNull(sink, "sink");
        long j = 0;
    ...
    */
    ...
    public long readHexadecimalUnsignedLong() throws IOException {
        ...
        if (i == 0) {
            ...
            String num = Integer.toString(b, CustomCharsKt.checkRadix(CustomCharsKt.checkRadix(16)));
    ...
    @Override // okio.BufferedSource
    public long indexOfElement(ByteString targetBytes, long j) throws IOException {
        Intrinsics.checkParameterIsNotNull(targetBytes, "targetBytes");
        if (!(!this.closed)) {
            throw new IllegalStateException("closed".toString());
        }
    ...
    @Override // okio.BufferedSource
    public boolean rangeEquals(long j, ByteString bytes, int i, int i2) throws IOException {
        int i3;
        Intrinsics.checkParameterIsNotNull(bytes, "bytes");
        if (!(!this.closed)) {
            throw new IllegalStateException("closed".toString());
