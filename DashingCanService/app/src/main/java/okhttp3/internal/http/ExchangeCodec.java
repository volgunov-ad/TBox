...
public interface ExchangeCodec {
    ...
    Response.Builder readResponseHeaders(boolean expectContinue) throws Throwable;

    long reportedContentLength(Response response) throws IOException;

    Headers trailers() throws Throwable;

    void writeRequestHeaders(Request request) throws Throwable;
