...
public class AndroidSocketAdapter implements SocketAdapter {
    ...
    public static final class Companion {
        ...
        public final SocketAdapter buildIfSupported(String packageName) throws NoSuchMethodException {
            ...
            androidSocketAdapter = new AndroidSocketAdapter((Class<? super SSLSocket>) cls);
