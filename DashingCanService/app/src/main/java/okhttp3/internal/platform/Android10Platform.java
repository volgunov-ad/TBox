...
public final class Android10Platform extends Platform {
    ...
    public Android10Platform() {
        List listOfNotNull = CollectionsKt.listOfNotNull((Object[]) new SocketAdapter[]{Android10SocketAdapter.INSTANCE.buildIfSupported(), ConscryptSocketAdapter.INSTANCE.buildIfSupported(), new DeferredSocketAdapter("com.google.android.gms.org.conscrypt")});
    ...
    public CertificateChainCleaner buildCertificateChainCleaner(X509TrustManager trustManager) {
        ...
        Android10CertificateChainCleaner buildIfSupported = Android10CertificateChainCleaner.INSTANCE.buildIfSupported(trustManager);
    ...
    static {
        isSupported = AndroidPlatform.INSTANCE.isAndroid() && Build.VERSION.SDK_INT >= 29;
    }
}
