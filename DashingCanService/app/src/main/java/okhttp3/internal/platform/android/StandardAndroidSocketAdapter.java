...
public final class StandardAndroidSocketAdapter extends AndroidSocketAdapter {
    ...
    public StandardAndroidSocketAdapter(Class<? super SSLSocket> sslSocketClass, Class<? super SSLSocketFactory> sslSocketFactoryClass, Class<?> paramClass) throws NoSuchMethodException {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ SocketAdapter buildIfSupported$default(Companion companion, String str, int i, Object obj) throws ClassNotFoundException, NoSuchMethodException {
            if ((i & 1) != 0) {
        ...
        public final SocketAdapter buildIfSupported(String packageName) throws ClassNotFoundException, NoSuchMethodException {
            ...
            standardAndroidSocketAdapter = new StandardAndroidSocketAdapter((Class<? super SSLSocket>) cls, (Class<? super SSLSocketFactory>) cls2, paramsClass);
