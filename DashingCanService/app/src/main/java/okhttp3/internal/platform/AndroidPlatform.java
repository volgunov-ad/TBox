...
public final class AndroidPlatform extends Platform {
    ...
    public AndroidPlatform() throws ClassNotFoundException, NoSuchMethodException {
        List listOfNotNull = CollectionsKt.listOfNotNull((Object[]) new SocketAdapter[]{StandardAndroidSocketAdapter.Companion.buildIfSupported$default(StandardAndroidSocketAdapter.INSTANCE, null, 1, null), ConscryptSocketAdapter.INSTANCE.buildIfSupported(), new DeferredSocketAdapter("com.google.android.gms.org.conscrypt")});
    ...
    public CertificateChainCleaner buildCertificateChainCleaner(X509TrustManager trustManager) {
        ...
        AndroidCertificateChainCleaner build = AndroidCertificateChainCleaner.INSTANCE.build(trustManager);
    ...
    public static final class Companion {
        ...
        public final Platform buildIfSupported() throws ClassNotFoundException, NoSuchMethodException {
            if (isSupported()) {
