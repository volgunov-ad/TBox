...
public abstract class Platform {
    ...
    public SSLContext newSSLContext() throws NoSuchAlgorithmException {
        SSLContext sSLContext = SSLContext.getInstance(CommonKt.CLIENT_AGREEMENT);
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void resetForTests$default(Companion companion, Platform platform, int i, Object obj) throws ClassNotFoundException, NoSuchMethodException {
            if ((i & 1) != 0) {
        ...
        public final Platform findPlatform() throws ClassNotFoundException, NoSuchMethodException {
            ...
            Platform buildIfSupported7 = Jdk8WithJettyBootPlatform.INSTANCE.buildIfSupported();
        ...
        public final byte[] concatLengthPrefixed(List<? extends Protocol> protocols) throws EOFException {
            Intrinsics.checkParameterIsNotNull(protocols, "protocols");
