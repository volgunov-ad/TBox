...
public interface SocketAdapter {
    void configureTlsExtensions(SSLSocket sslSocket, String hostname, List<? extends Protocol> protocols) throws IOException, NoSuchMethodException;

    String getSelectedProtocol(SSLSocket sslSocket) throws NoSuchMethodException;
