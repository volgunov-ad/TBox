...
public final class TaskQueue {
        ...
        synchronized (this.taskRunner) {
            if (this.shutdown) {
                if (task.getCancelable()) {
                    assert TaskRunner.INSTANCE.getLogger() != null;
                    LogRecord LogRecord = null;
                    if (TaskRunner.INSTANCE.getLogger().isLoggable(LogRecord)) {
    ...
    public final void schedule(String r2, long delayNanos, Function0<Long> block) {
        Intrinsics.checkParameterIsNotNull(r2, "name");
        Intrinsics.checkParameterIsNotNull(block, "block");
        schedule(new TaskQueue$schedule$2(block, r2, r2), delayNanos);
    }
    ...
    public final void execute(String r8, long delayNanos, boolean cancelable, Function0<Unit> block) {
        Intrinsics.checkParameterIsNotNull(r8, "name");
        Intrinsics.checkParameterIsNotNull(block, "block");
        schedule(new TaskQueue$execute$1(block, r8, cancelable, r8, cancelable), delayNanos);
    }
