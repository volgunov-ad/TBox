...
public final class HostnamesKt {
    public static final String toCanonicalHost(String toCanonicalHost) throws EOFException {
        InetAddress decodeIpv6;
        Intrinsics.checkParameterIsNotNull(toCanonicalHost, "$this$toCanonicalHost");
        if (StringsKt.contains((CharSequence) toCanonicalHost, (CharSequence) ":", false)) {
            if (StringsKt.startsWith(toCanonicalHost, "[", false) && StringsKt.endsWith(toCanonicalHost, "]", false)) {
    ...
    private static final boolean containsInvalidHostnameAsciiCodes(String str) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (charAt <= 31 || charAt >= 127 || StringsKt.indexOf((CharSequence) " #%/:?@[\\]", charAt, 0, false) != -1) {
                return true;
            }
        }
        return false;
    ...
    */
    private static final InetAddress decodeIpv6(String r18, int r19, int r20) {
        /*
    ...
    private static final String inet6AddressToAscii(byte[] bArr) throws EOFException {
        int i = 0;
        int i2 = -1;
        int i3 = 0;
        int i4 = 0;
