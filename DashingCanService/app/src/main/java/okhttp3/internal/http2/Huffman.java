...
public final class Huffman {
    ...
    public final void encode(ByteString source, BufferedSink sink) throws Throwable {
    ...
    public final void decode(BufferedSource source, long byteCount, BufferedSink sink) throws Throwable {
        Intrinsics.checkParameterIsNotNull(source, "source");
        Intrinsics.checkParameterIsNotNull(sink, "sink");
        Node node = root;
        int i = 0;
