...
public final class Http2Stream {
    ...
    public final synchronized Headers takeHeaders() throws Throwable {
        Headers removeFirst;
    ...
    public final synchronized Headers trailers() throws Throwable {
        Headers trailers;
        if (this.errorCode != null) {
    ...
    public final void close(ErrorCode rstStatusCode, IOException errorException) throws Throwable {
    ...
    public final class FramingSource implements Source {
        ...
        */
        public long read(okio.Buffer r18, long r19) throws IOException {
            /*
    ...
    */
    ...
    public final void cancelStreamIfNecessary$okhttp() throws Throwable {
        boolean z;
        boolean isOpen;
        if (!Util.assertionsEnabled || !Thread.holdsLock(this)) {
            synchronized (this) {
