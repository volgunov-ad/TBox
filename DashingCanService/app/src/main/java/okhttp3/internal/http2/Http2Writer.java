...
public final class Http2Writer implements Closeable {
    ...
    public final synchronized void connectionPreface() throws Throwable {
        if (this.closed) {
    ...
    public final synchronized void applyAndAckSettings(Settings peerSettings) throws Throwable {
    ...
    public final synchronized void pushPromise(int streamId, int promisedStreamId, List<Header> requestHeaders) throws Throwable {
    ...
    public final synchronized void rstStream(int streamId, ErrorCode errorCode) throws Throwable {
    ...
    public final synchronized void data(boolean z, int i, Buffer buffer, int i2) throws Throwable {
        if (this.closed) {
            throw new IOException("closed");
        }
    ...
    public final void dataFrame(int streamId, int flags, Buffer buffer, int byteCount) throws Throwable {
    ...
    public final synchronized void settings(Settings settings) throws Throwable {
    ...
    public final synchronized void ping(boolean ack, int payload1, int payload2) throws Throwable {
        if (this.closed) {
            throw new IOException("closed");
        }
    ...
    public final synchronized void goAway(int lastGoodStreamId, ErrorCode errorCode, byte[] debugData) throws Throwable {
        Intrinsics.checkParameterIsNotNull(errorCode, "errorCode");
    ...
    public final synchronized void windowUpdate(int streamId, long windowSizeIncrement) throws Throwable {
        if (this.closed) {
            throw new IOException("closed");
        }
    ...
    public final void frameHeader(int streamId, int length, int type, int flags) throws Throwable {
        if (logger.isLoggable(Level.FINE)) {
    ...
    private final void writeContinuationFrames(int streamId, long byteCount) throws Throwable {
        while (byteCount > 0) {
    ...
    public final synchronized void headers(boolean outFinished, int streamId, List<Header> headerBlock) throws Throwable {
