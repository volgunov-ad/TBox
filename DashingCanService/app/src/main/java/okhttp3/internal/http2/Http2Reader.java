...
public final class Http2Reader implements Closeable {
    ...
    private final void readHeaders(Handler handler, int length, int flags, int streamId) throws Throwable {
        if (streamId == 0) {
    ...
    private final List<Header> readHeaderBlock(int length, int padding, int flags, int streamId) throws Throwable {
    ...
    */
    private final void readSettings(Handler r8, int r9, int r10, int r11) throws IOException {
        /*
            r7 = this;
            if (r11 != 0) goto Lc4
            r11 = 1
    ...
    private final void readPushPromise(Handler handler, int length, int flags, int streamId) throws Throwable {
        if (streamId == 0) {
