...
public final class WebSocketWriter implements Closeable {
    ...
    public final void writeMessageFrame(int formatOpcode, ByteString r7) throws Throwable {
        Intrinsics.checkParameterIsNotNull(r7, "data");
        if (this.writerClosed) {
            throw new IOException("closed");
        }
        this.messageBuffer.write(r7);
        int i = formatOpcode | 128;
        if (this.perMessageDeflate && r7.size() >= this.minimumDeflateSize) {
