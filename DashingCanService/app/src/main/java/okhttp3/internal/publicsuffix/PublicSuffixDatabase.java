...
public final class PublicSuffixDatabase {
    ...
    public final String getEffectiveTldPlusOne(String domain) {
        ...
        List<String> split$default = StringsKt.split((CharSequence) unicodeDomain, new char[]{'.'}, false, 0);
        ...
        return SequencesKt.joinToString(SequencesKt.drop(CollectionsKt.asSequence(StringsKt.split((CharSequence) domain, new char[]{'.'}, false, 0)), size - size2), ".", null, null, 0, null, null);
    }
    ...
    private final List<String> findMatchingRule(List<String> domainLabels) {
        ...
        byte[][] bArr = new byte[][]{new byte[size]};
        ...
        if (str4 != null) {
            return StringsKt.split((CharSequence) (EXCEPTION_MARKER + str4), new char[]{'.'}, false, 0);
        }
        if (str == null && str2 == null) {
            return PREVAILING_RULE;
        }
        if (str == null || (emptyList = StringsKt.split((CharSequence) str, new char[]{'.'}, false, 0)) == null) {
            emptyList = CollectionsKt.emptyList();
        }
        if (str2 == null || (emptyList2 = StringsKt.split((CharSequence) str2, new char[]{'.'}, false, 0)) == null) {
    ...
    public static final class Companion {
        ...
        public static final PublicSuffixDatabase get() {
