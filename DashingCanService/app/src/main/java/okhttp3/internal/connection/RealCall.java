...
public final class RealCall implements Call {
    ...
    public RealCall(OkHttpClient client, Request originalRequest, boolean z) {
        ...
        AsyncTimeout r2 = new AsyncTimeout() { // from class: okhttp3.internal.connection.RealCall$timeout$1
    ...
    public final void enterNetworkInterceptorExchange(Request request, boolean z) throws EOFException {
    ...
    public final <E extends IOException> E messageDone$okhttp(Exchange exchange, boolean z, boolean z2, E e) {
        ...
        synchronized (this.connectionPool) {
            ...
            if (this.exchangeRequestDone && this.exchangeResponseDone && z3) {
                ...
                RealConnection connection$okhttp = exchange2.getConnection();
                connection$okhttp.setSuccessCount$okhttp(connection$okhttp.getSuccessCount() + 1);
                this.exchange = null;
            } else {
                z4 = false;
            }
    ...
    */
    ...
    private final Address createAddress(HttpUrl httpUrl) throws EOFException {
    ...
    public final String toLoggableString() throws EOFException {
        StringBuilder sb = new StringBuilder();
    ...
    public final String redactedUrl$okhttp() throws EOFException {
