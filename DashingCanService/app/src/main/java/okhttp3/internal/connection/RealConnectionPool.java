...
public final class RealConnectionPool {
    ...
    public RealConnectionPool(TaskRunner taskRunner, int i, long j, TimeUnit timeUnit) {
        ...
        this.cleanupTask = new Task(str, true) { // from class: okhttp3.internal.connection.RealConnectionPool$cleanupTask$1
        ...
        synchronized (this) {
            ...
            while (it.hasNext()) {
                ...
                if (pruneAndGetAllocationCount(connection, j) > 0) {
                    ...
                    i++;
                    long idleAtNs$okhttp = j - connection.getIdleAtNs();
    ...
    public final boolean callAcquirePooledConnection(Address address, RealCall call, List<Route> list, boolean z) throws EOFException {
