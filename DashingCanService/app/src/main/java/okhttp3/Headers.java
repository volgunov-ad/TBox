...
public final class Headers implements Iterable<Pair<? extends String, ? extends String>>, KMappedMarker {
    ...
    public final String get(String r3) {
        Intrinsics.checkParameterIsNotNull(r3, "name");
        return INSTANCE.get(this.namesAndValues, r3);
    }

    public final Date getDate(String r2) {
    ...
    public final Instant getInstant(String r2) {
        Intrinsics.checkParameterIsNotNull(r2, "name");
        Date date = getDate(r2);
        if (date != null) {
    ...
    public final int m1072deprecated_size() {
        return size();
    }
    ...
    public final List<String> values(String r6) {
        Intrinsics.checkParameterIsNotNull(r6, "name");
        ArrayList arrayList = (ArrayList) null;
        int size = size();
        for (int i = 0; i < size; i++) {
            if (StringsKt.equals(r6, name(i), true)) {
                if (arrayList == null) {
    ...
    /* compiled from: Headers.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010!\n\u0002\u0010\u000e\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\b\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u000e\u0010\b\u001a\u00020\u00002\u0006\u0010\t\u001a\u00020\u0005J\u0018\u0010\b\u001a\u00020\u00002\u0006\u0010\n\u001a\u00020\u00052\u0006\u0010\u000b\u001a\u00020\fH\u0007J\u0016\u0010\b\u001a\u00020\u00002\u0006\u0010\n\u001a\u00020\u00052\u0006\u0010\u000b\u001a\u00020\rJ\u0016\u0010\b\u001a\u00020\u00002\u0006\u0010\n\u001a\u00020\u00052\u0006\u0010\u000b\u001a\u00020\u0005J\u000e\u0010\u000e\u001a\u00020\u00002\u0006\u0010\u000f\u001a\u00020\u0010J\u0015\u0010\u0011\u001a\u00020\u00002\u0006\u0010\t\u001a\u00020\u0005H\u0000¢\u0006\u0002\b\u0012J\u001d\u0010\u0011\u001a\u00020\u00002\u0006\u0010\n\u001a\u00020\u00052\u0006\u0010\u000b\u001a\u00020\u0005H\u0000¢\u0006\u0002\b\u0012J\u0016\u0010\u0013\u001a\u00020\u00002\u0006\u0010\n\u001a\u00020\u00052\u0006\u0010\u000b\u001a\u00020\u0005J\u0006\u0010\u0014\u001a\u00020\u0010J\u0013\u0010\u0015\u001a\u0004\u0018\u00010\u00052\u0006\u0010\n\u001a\u00020\u0005H\u0086\u0002J\u000e\u0010\u0016\u001a\u00020\u00002\u0006\u0010\n\u001a\u00020\u0005J\u0019\u0010\u0017\u001a\u00020\u00002\u0006\u0010\n\u001a\u00020\u00052\u0006\u0010\u000b\u001a\u00020\fH\u0087\u0002J\u0019\u0010\u0017\u001a\u00020\u00002\u0006\u0010\n\u001a\u00020\u00052\u0006\u0010\u000b\u001a\u00020\rH\u0086\u0002J\u0019\u0010\u0017\u001a\u00020\u00002\u0006\u0010\n\u001a\u00020\u00052\u0006\u0010\u000b\u001a\u00020\u0005H\u0086\u0002R\u001a\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004X\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\u0018"}, d2 = {"Lokhttp3/Headers$Builder;", "", "()V", "namesAndValues", "", "", "getNamesAndValues$okhttp", "()Ljava/util/List;", "add", "line", MBParams.NAME, "value", "Ljava/time/Instant;", "Ljava/util/Date;", "addAll", "headers", "Lokhttp3/Headers;", "addLenient", "addLenient$okhttp", "addUnsafeNonAscii", "build", "get", "removeAll", "set", "okhttp"}, k = 1, mv = {1, 1, 16})
    /* loaded from: classes2.dex */
    public static final class Builder {
        ...
        public final Builder addLenient$okhttp(String line) {
            ...
            int indexOf$default = StringsKt.indexOf((CharSequence) line, ':', 1, false);
        ...
        public final Builder add(String line) {
            Intrinsics.checkParameterIsNotNull(line, "line");
            Builder builder = this;
            int indexOf$default = StringsKt.indexOf((CharSequence) line, ':', 0, false);
            if (!(indexOf$default != -1)) {
        ...
        public final Builder add(String r3, String value) {
            Intrinsics.checkParameterIsNotNull(r3, "name");
            Intrinsics.checkParameterIsNotNull(value, "value");
            Builder builder = this;
            Headers.INSTANCE.checkName(r3);
            Headers.INSTANCE.checkValue(value, r3);
            builder.addLenient$okhttp(r3, value);
            return builder;
        }

        public final Builder addUnsafeNonAscii(String r3, String value) {
            Intrinsics.checkParameterIsNotNull(r3, "name");
            Intrinsics.checkParameterIsNotNull(value, "value");
            Builder builder = this;
            Headers.INSTANCE.checkName(r3);
        ...
        public final Builder add(String r2, Date value) {
            Intrinsics.checkParameterIsNotNull(r2, "name");
            Intrinsics.checkParameterIsNotNull(value, "value");
            Builder builder = this;
            builder.add(r2, DatesKt.toHttpDateString(value));
            return builder;
        }

        public final Builder add(String r5, Instant value) {
            Intrinsics.checkParameterIsNotNull(r5, "name");
            Intrinsics.checkParameterIsNotNull(value, "value");
            Builder builder = this;
            builder.add(r5, new Date(value.toEpochMilli()));
            return builder;
        }

        public final Builder set(String r2, Date value) {
            Intrinsics.checkParameterIsNotNull(r2, "name");
            Intrinsics.checkParameterIsNotNull(value, "value");
            Builder builder = this;
            builder.set(r2, DatesKt.toHttpDateString(value));
            return builder;
        }

        public final Builder set(String r5, Instant value) {
            Intrinsics.checkParameterIsNotNull(r5, "name");
            Intrinsics.checkParameterIsNotNull(value, "value");
            return set(r5, new Date(value.toEpochMilli()));
        }

        public final Builder addLenient$okhttp(String r3, String value) {
            Intrinsics.checkParameterIsNotNull(r3, "name");
            Intrinsics.checkParameterIsNotNull(value, "value");
            Builder builder = this;
            builder.namesAndValues.add(r3);
            builder.namesAndValues.add(StringsKt.trim((CharSequence) value).toString());
            return builder;
        }

        public final Builder removeAll(String r5) {
            Intrinsics.checkParameterIsNotNull(r5, "name");
            Builder builder = this;
            int i = 0;
            while (i < builder.namesAndValues.size()) {
                if (StringsKt.equals(r5, builder.namesAndValues.get(i), true)) {
        ...
        public final Builder set(String r3, String value) {
            Intrinsics.checkParameterIsNotNull(r3, "name");
            Intrinsics.checkParameterIsNotNull(value, "value");
            Builder builder = this;
            Headers.INSTANCE.checkName(r3);
            Headers.INSTANCE.checkValue(value, r3);
            builder.removeAll(r3);
            builder.addLenient$okhttp(r3, value);
            return builder;
        }

        public final String get(String r6) {
            Intrinsics.checkParameterIsNotNull(r6, "name");
            ...
            while (!StringsKt.equals(r6, this.namesAndValues.get(first), true)) {
                if (first == last) {
                    return null;
                }
                first += step2;
    ...
    public static final class Companion {
        ...
        public final String get(String[] namesAndValues, String r7) {
            ...
            while (!StringsKt.equals(r7, namesAndValues[first], true)) {
                if (first == last) {
                    return null;
                }
                first += step2;
        ...
        public final Headers m1074deprecated_of(String... namesAndValues) {
            Intrinsics.checkParameterIsNotNull(namesAndValues, "namesAndValues");
        ...
        /* renamed from: -deprecated_of */
        public final Headers m1073deprecated_of(Map<String, String> headers) {
            Intrinsics.checkParameterIsNotNull(headers, "headers");
            return of(headers);
        }

        public final void checkName(String r8) {
            if (!(r8.length() > 0)) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (!('!' <= charAt && '~' >= charAt)) {
                    throw new IllegalArgumentException(Util.format("Unexpected char %#04x at %d in header name: %s", Integer.valueOf(charAt), Integer.valueOf(i), r8).toString());
                }
            }
        }

        public final void checkValue(String value, String r9) {
            int length = value.length();
            for (int i = 0; i < length; i++) {
                char charAt = value.charAt(i);
                if (!(charAt == '\t' || (' ' <= charAt && '~' >= charAt))) {
                    throw new IllegalArgumentException(Util.format("Unexpected char %#04x at %d in %s value: %s", Integer.valueOf(charAt), Integer.valueOf(i), r9, value).toString());
                }
            }
        }
    }
