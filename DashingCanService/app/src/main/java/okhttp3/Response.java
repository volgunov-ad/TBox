...
public final class Response implements Closeable {
    ...
    public final String header(String r2, String defaultValue) {
        Intrinsics.checkParameterIsNotNull(r2, "name");
        String str = this.headers.get(r2);
    ...
    public final Headers trailers() throws Throwable {
    ...
    public final CacheControl m1142deprecated_cacheControl() {
        return cacheControl();
    }
    ...
    public static class Builder {
        ...
        private final void checkSupportResponse(String r4, Response response) {
            if (response != null) {
                if (!(response.body() == null)) {
                    throw new IllegalArgumentException((r4 + ".body != null").toString());
                }
                if (!(response.networkResponse() == null)) {
                    throw new IllegalArgumentException((r4 + ".networkResponse != null").toString());
                }
                if (!(response.cacheResponse() == null)) {
                    throw new IllegalArgumentException((r4 + ".cacheResponse != null").toString());
                }
                if (response.priorResponse() == null) {
                    return;
                }
                throw new IllegalArgumentException((r4 + ".priorResponse != null").toString());
            }
        }
