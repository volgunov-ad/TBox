...
public final class Cache implements Closeable, Flushable {
    ...
    @JvmStatic
    public static final String key(HttpUrl httpUrl) throws NoSuchAlgorithmException {
    ...
    public final void remove$okhttp(Request request) throws Throwable {
        Intrinsics.checkParameterIsNotNull(request, "request");
    ...
    public final File m1035deprecated_directory() {
        return this.cache.getDirectory();
    }
    ...
    private final class RealCacheRequest implements CacheRequest {
        ...
        @Override
        public Sink getBody() throws IOException {
            return null;
        }
    ...
    private static final class Entry {
        ...
        private final boolean isHttps() {
            return StringsKt.startsWith(this.url, "https://", false);
        }
        ...
        public final Response response(DiskLruCache.Snapshot snapshot) throws EOFException {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        public final String key(HttpUrl url) throws NoSuchAlgorithmException {
        ...
        private final Set<String> varyFields(Headers headers) {
            ...
            for (int i = 0; i < size; i++) {
                if (StringsKt.equals("Vary", headers.name(i), true)) {
                    ...
                    for (String str : StringsKt.split((CharSequence) value, new char[]{','}, false, 0)) {
                        if (str == null) {
