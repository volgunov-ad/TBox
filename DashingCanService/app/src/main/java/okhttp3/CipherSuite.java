...
public final class CipherSuite {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        public static final synchronized CipherSuite forJavaName(String javaName) {
        ...
        private static final String secondaryName(String javaName) {
            if (StringsKt.startsWith(javaName, "TLS_", false)) {
            ...
            if (!StringsKt.startsWith(javaName, "SSL_", false)) {
                return javaName;
            }
