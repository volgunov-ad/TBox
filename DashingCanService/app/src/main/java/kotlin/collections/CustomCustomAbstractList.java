...
public abstract class CustomCustomAbstractList<E> extends CustomAbstractCollection<E> implements List<E>, KMappedMarker {
    ...
    public List<E> subList(int i, int i2) {
        return new SubListCustom(this, i, i2);
    }
    ...
    /* loaded from: classes2.dex */
    private static final class SubListCustom<E> extends CustomCustomAbstractList<E> implements RandomAccess {
        private int _size;
        private final int fromIndex;
        private final CustomCustomAbstractList<E> list;

        /* JADX WARN: Multi-variable type inference failed */
        public SubListCustom(CustomCustomAbstractList<? extends E> list, int i, int i2) {
            Intrinsics.checkParameterIsNotNull(list, "list");
            this.list = (CustomCustomAbstractList<E>) list;
            this.fromIndex = i;
            CustomCustomAbstractList.Companion.checkRangeIndexes$kotlin_stdlib(this.fromIndex, i2, this.list.size());
            this._size = i2 - this.fromIndex;
        }

        @Override // kotlin.collections.AbstractList, java.util.List
        public E get(int i) {
            CustomCustomAbstractList.Companion.checkElementIndex$kotlin_stdlib(i, this._size);
    ...
    public class IteratorImpl implements Iterator<E>, KMappedMarker {
        ...
        public boolean hasNext() {
            return this.index < CustomCustomAbstractList.this.size();
        }
        ...
        public E next() {
            ...
            CustomCustomAbstractList customAbstractList = CustomCustomAbstractList.this;
            int i = this.index;
            this.index = i + 1;
            return (E) customAbstractList.get(i);
        }
    }
    ...
    /* loaded from: classes2.dex */
    private class ListIteratorImpl extends CustomCustomAbstractList<E>.IteratorImpl implements ListIterator<E>, KMappedMarker {
        ...
        public ListIteratorImpl(int i) {
            super();
            CustomCustomAbstractList.Companion.checkPositionIndex$kotlin_stdlib(i, CustomCustomAbstractList.this.size());
            setIndex(i);
        }
        ...
        public E previous() {
            ...
            CustomCustomAbstractList customAbstractList = CustomCustomAbstractList.this;
            setIndex(getIndex() - 1);
            return (E) customAbstractList.get(getIndex());
        }
