...
**Текущая версия:** 1.0.0 (`ru` / `en` flavor).
...
* **Интерфейс:** вкладки «Модем», «Данные авто», «Геопозиция», «Поездки», **«Заправки»**, **«Автоматизации»**, **«Темы»**, «Плитки», настройки; **главный экран** с панелями и обоями; **плавающие панели** поверх других приложений; настраиваемый вид плиток (выравнивание, вес шрифта, зазор сетки).
* **Автоматизации:** свои правила «если случилось — сделать» (машина, время, место, приложение, Wi‑Fi) без открытого экрана приложения.
...
| Файл | Содержание |
|------|------------|
| [docs/USER_GUIDE_RU.md](docs/USER_GUIDE_RU.md) | Руководство пользователя (коротко: интерфейс, панели, основные шаги); PDF: [docs/USER_GUIDE_RU.pdf](docs/USER_GUIDE_RU.pdf) |
...
| [Changelog.dm](Changelog.dm) | История версий по релизам (0.12 … 1.0.0) |
