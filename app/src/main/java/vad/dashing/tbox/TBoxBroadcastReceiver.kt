...
class TboxBroadcastReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val MAIN_ACTION = "vad.dashing.tbox.main_action"
        const val GET_STATE = "vad.dashing.tbox.get_state"
        const val SUBSCRIBE = "vad.dashing.tbox.subscribe"
        const val UNSUBSCRIBE = "vad.dashing.tbox.unsubscribe"
