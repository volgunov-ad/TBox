...
@Composable
fun DashboardRearFogWidgetItem(
    onClick: () -> Unit,
    onLongClick: () -> Unit,
    elevation: Dp,
    shape: Dp,
    ...
    val defaultTitle = stringResource(R.string.data_title_rear_fog_widget)
    ...
    DashboardWidgetScaffold(
        ...
        DashboardWidgetContentWithOptionalTitle(
            ...
            WidgetControlChrome(
                ...
                Image(
                    painter = customizableUiPainter(id = R.drawable.ic_widget_rear_fog),
