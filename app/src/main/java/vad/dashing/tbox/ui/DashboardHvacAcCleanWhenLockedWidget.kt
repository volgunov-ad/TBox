...
@Composable
fun DashboardHvacAcCleanWhenLockedWidgetItem(
    onClick: () -> Unit,
    onLongClick: () -> Unit,
    elevation: Dp,
    shape: Dp,
    ...
    val state by UniversalCanRepository.hvacAcCleanWhenLockedState.collectAsStateWithLifecycle()
    ...
    val defaultTitle = stringResource(R.string.data_title_hvac_ac_clean_when_locked_widget)
    ...
    DashboardWidgetScaffold(
        ...
        DashboardWidgetContentWithOptionalTitle(
            ...
            WidgetControlChrome(
                ...
                Image(
                    painter = customizableUiPainter(id = R.drawable.ic_widget_hvac_ac_clean_when_locked),
