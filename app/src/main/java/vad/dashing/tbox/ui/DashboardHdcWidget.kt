...
fun DashboardHdcWidgetItem(
    ...
    val state by UniversalCanRepository.hdcState.collectAsStateWithLifecycle()
    ...
    val defaultTitle = stringResource(R.string.data_title_hdc_widget)
    ...
    DashboardWidgetScaffold(
        ...
        DashboardWidgetContentWithOptionalTitle(
            ...
            WidgetControlChrome(
                ...
                Image(
                    painter = customizableUiPainter(id = R.drawable.ic_widget_hdc),
                    contentDescription = null,
                    contentScale = ContentScale.Fit,
                    modifier = Modifier.fillMaxSize().scale(iconScale),
                    colorFilter = uiIconColorFilter(R.drawable.ic_widget_hdc, iconColor)
                )
            }
        }
    }
