...
fun DashboardAvhWidgetItem(
    ...
    val state by UniversalCanRepository.avhState.collectAsStateWithLifecycle()
    ...
    val defaultTitle = stringResource(R.string.data_title_avh_widget)
    ...
    DashboardWidgetScaffold(
        ...
        DashboardWidgetContentWithOptionalTitle(
            ...
            WidgetControlChrome(
                ...
                Image(
                    painter = customizableUiPainter(id = R.drawable.ic_widget_avh),
                    contentDescription = null,
                    contentScale = ContentScale.Fit,
                    modifier = Modifier.fillMaxSize().scale(iconScale),
                    colorFilter = uiIconColorFilter(R.drawable.ic_widget_avh, iconColor)
                )
            }
        }
    }
