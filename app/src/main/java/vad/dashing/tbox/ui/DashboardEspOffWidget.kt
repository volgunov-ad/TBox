...
fun DashboardEspOffWidgetItem(
    ...
    val defaultTitle = stringResource(R.string.data_title_esp_off_widget)
    ...
    DashboardWidgetScaffold(
        ...
        DashboardWidgetContentWithOptionalTitle(
            ...
            WidgetControlChrome(
                ...
                Image(
                    painter = customizableUiPainter(id = R.drawable.ic_widget_esp_off),
                    contentDescription = null,
                    contentScale = ContentScale.Fit,
                    modifier = Modifier.fillMaxSize().scale(iconScale),
                    colorFilter = uiIconColorFilter(R.drawable.ic_widget_esp_off, iconColor)
                )
            }
        }
    }
