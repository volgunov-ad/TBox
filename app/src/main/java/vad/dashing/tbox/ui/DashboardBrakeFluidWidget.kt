...
@Composable
fun DashboardBrakeFluidWidgetItem(
    onClick: () -> Unit,
    onLongClick: () -> Unit,
    elevation: Dp,
    shape: Dp,
    ...
    val warning by UniversalCanRepository.brakeFluidWarningState.collectAsStateWithLifecycle()
    ...
    val defaultTitle = stringResource(R.string.data_title_brake_fluid_widget)
    ...
    DashboardWidgetScaffold(
        ...
        DashboardWidgetContentWithOptionalTitle(
            ...
            WidgetControlChrome(
                ...
                Image(
                    painter = customizableUiPainter(id = R.drawable.ic_widget_brake_fluid),
