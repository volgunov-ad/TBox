...
fun lightColorScheme() = androidx.compose.material3.lightColorScheme(
    ...
    background = Color(LIGHT_THEME_BACKGROUND_COLOR_PRESET_2_INT),
    onBackground = Color(LIGHT_THEME_TEXT_COLOR_PRESET_1_INT),
    surface = Color(LIGHT_THEME_BACKGROUND_COLOR_PRESET_1_INT),
...
fun darkColorScheme() = androidx.compose.material3.darkColorScheme(
    ...
    background = Color(DARK_THEME_BACKGROUND_COLOR_PRESET_2_INT),
    onBackground = Color(DARK_THEME_TEXT_COLOR_PRESET_1_INT),
    surface = Color(DARK_THEME_BACKGROUND_COLOR_PRESET_1_INT),
