...
- [x] Тень зелёным, GNSS оранжевым кольцом поверх тени, стрелки по курсу
- [x] Auto-fit вокруг тени с GNSS/рёбрами в кадре и ограничением масштаба (локально, без fit всего ребра)
- [x] GNSS скрыт без живого фикса (USB/ESP down / stale LocValues); не дублирует тень
