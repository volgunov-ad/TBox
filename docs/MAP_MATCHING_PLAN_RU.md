...
- Режим **«Задать»** без изменений: north-up, pinch, тень в центре.
...
2. После нажатия кнопка сменяется на **«Применить»** и **«Отмена»**. Плитка входит в set-mode:
   ...
   - вокруг тени **кольцо курса**: палец по дуге поворачивает направление черновика; на кольце **засечка** в выбранном курсе;
