...
| Recover / нет sticky / после LOW-reject: ≥ **6 м** или ≥ **1 с** | Учащённый match |
| Ожидание confirm смены ребра: ≥ **5 м** или ≥ **1 с** | Учащённый match |
...
- [x] Lateral snap гасится при residual ≥28° (не на каждом `dueTurn`), слабее при xt > 8 м, растущем xt и близком runner-up; на прямой с одним кандидатом шаг как раньше (40% / ≤2.5 м).
...
- [x] Адаптивный throttle: прямая 12 м / 2 с / 18°; recover и switch-pending — 5–6 м / 1 с.
