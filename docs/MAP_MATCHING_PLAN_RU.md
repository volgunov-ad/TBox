...
- [x] Hint поворотника на развилке: `TurnSignalsLatch` (L/R, hold 2,5 с после
  вспышки / стебля; встречная сторона и аварийка сбрасывают чужую защёлку).
  Instant `forkHintSide` остаётся сырым. Если в ranked уже есть **связанный**
