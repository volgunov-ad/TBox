...
В режиме **Продвинутый** при доверенном GNSS приложение понемногу подстраивает bias на прямых и scale на поворотах (без бокового ускорения). То же — в режимах **Всегда** / **При потере**, пока GNSS правдив (запас на будущий DR).
