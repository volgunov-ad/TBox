...
на всё время записи. На штатном Android 10/VHAL свойства угла руля сейчас нет,
поэтому `angleDeg=-`; поле оставлено для сравнения и будущего VHAL id. Значение
пока только записывается для оценки и не участвует в калибровке или DR.
