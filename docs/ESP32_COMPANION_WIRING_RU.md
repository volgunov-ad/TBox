...
**Не подключать:** MCP2515 **INT** (прошивка опрашивает). Для BLE (Shelly Blu, fw 0.8+) магнитометр лучше держать на выносном кабеле 20–50 см — прошивка mag при BLE не останавливает.
