...
**Настройки плавающих панелей** → добавить → разрешить «Поверх других окон» → задать размер в px, расстояние между плитками (на выбранную панель), **общий** шаг сетки для всех плавающих панелей и опционально «Перемещать за пределы экрана».
