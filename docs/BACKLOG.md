...
| # | Задача | Источник | Область кода | Сложн. |
|---|--------|----------|--------------|--------|
| F-01 | **Кнопка «Обновить данные по заправке»** — в меню «Заправки», когда появился интернет (повторная подтяжка цен АЗС / пересчёт оценок). | «…кнопку - обновить данные по заправке в меню Заправки, когда интернет появился» | `fuel/`, вкладка заправок UI, сетевой слой цен | S *(реализовано)* |
