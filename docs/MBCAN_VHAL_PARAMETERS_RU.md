...
| **Android 9** — Wheel pulse counters | `MBCanVehicleWheel` / `eMBCAN_VEHICLE_WHEEL` (4); LHF/RHF/LHR/RHR | int counters as-is | — | **Push:** `IMBVehicleListener.onPull` (`syncImbVehicleListener` + interest `WheelPulse`) + pull; `WheelPulseOdometer` |
| **Android 10** — Wheel pulse counters | VHAL **289412182/179/175/177** `R_0400_ESP_5_*PulseCounter` LHF/RHF/LHR/RHR | int counters as-is | — | onChange + pull (`MbCanSignal.WheelPulse`); `WheelPulseOdometer` |
