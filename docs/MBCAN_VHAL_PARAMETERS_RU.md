...
| **Android 9** — Wheel pulse counters | `MBCanVehicleWheel` / `eMBCAN_VEHICLE_WHEEL` (4); LHF/RHF/LHR/RHR | int counters as-is | — | pull (`MbCanSignal.WheelPulse`); `WheelPulseOdometer` |
