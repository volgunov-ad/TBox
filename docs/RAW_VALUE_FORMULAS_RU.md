...
|----------|--------------------------|------------|------------|-----|
| Скорость | CAN `0x430`/`0x502`/`0x310`: **raw/16**; Cycle: **raw/16**; LOC GPS: **raw/10** | as-is (float ≥ 0) | **289414964** DisplayVehicleSpeed: **UINT16(raw)/16** | км/ч |
...
| Vehicle speed | telemetry float | **289414964** (`DisplayVehicleSpeed`) | **UINT16(raw) / 16** (≥ 0) | — | км/ч |
